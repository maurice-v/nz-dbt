...
class TestNetezzaAdapterConversions(AdapterConversions):
    ...
    def test_convert_boolean_type(self):
        ...
        for col_idx, expect in enumerate(expected):
            assert NetezzaAdapter.convert_boolean_type(agate_table, col_idx) == expect
    ...
    def test_convert_date_type(self):
        ...
        for col_idx, expect in enumerate(expected):
            assert NetezzaAdapter.convert_date_type(agate_table, col_idx) == expect
    ...
    def test_convert_time_type(self):
        ...
        for col_idx, expect in enumerate(expected):
            assert NetezzaAdapter.convert_time_type(agate_table, col_idx) == expect
